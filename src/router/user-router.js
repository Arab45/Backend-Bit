...
const { loginProcess, loginIn, verifyLoginUserToken, logOut, forgetPasswordToken, resetPassword } = require("../controller/userAuth-controller");
...
router.post('/signIn', loginProcess, loginIn);
